...
//        Router::extensions('json');
        ...
        $routes->connect('/search', ['controller' => 'Search', 'action' => 'simpleSearch', '_method' => 'POST']);
        $routes->connect('/search/advanced', ['controller' => 'Search', 'action' => 'advancedSearch', '_method' => 'POST']);

        $routes->connect('/signin', ['controller' => 'Auth', 'action' => 'signin', '_method' => 'POST']);
